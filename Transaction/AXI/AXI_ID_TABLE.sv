...
module AXI_ID_TABLE #(parameter TIMEOUT = 50_000, parameter PERIOD = 10, parameter DATA_WIDTH = 32, parameter MEMORY_DEPTH = 16)
(
input   logic          clk,
input   logic          rst,
...
logic [MEMORY_DEPTH-1:0]    ARB_FREE_X; //ARBITER
