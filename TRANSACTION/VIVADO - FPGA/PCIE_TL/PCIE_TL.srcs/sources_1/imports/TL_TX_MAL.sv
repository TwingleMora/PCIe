...
//TL_TX_MALUFACTURED
module TL_TX_MAL #(parameter BUS_ID = 0,parameter DEVICE_ID = 0, parameter FUNCTION_ID = 0, parameter BUS_WIDTH = 128, parameter DEPTH = 10 )
(
input   logic                    clk, 
input   logic                    rst,
...
TX_PNPC_BUFF #(.DATA_WIDTH(BUS_WIDTH), .DEPTH(DEPTH)) PNPC_BUFF0
(
    .clk(clk),                              //input  logic                     clk,
    .rst(rst),                              //input  logic                     rst,
    .HEADER_DATA(HEADER_DATA),              //input  logic                     HEADER_DATA, // 0: Header, 1: Data
