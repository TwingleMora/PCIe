...
module TRANSACTION_RX_TOP #(parameter DATA_WIDTH = 32, parameter ADDR_WIDTH = 32, parameter BUS_WIDTH = 128, parameter DEPTH = 10 )(
...
RX_PNPC_BUFF #(.DATA_WIDTH(BUS_WIDTH), .DEPTH(DEPTH)) PNPC_BUFF0
(
