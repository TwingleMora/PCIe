...
input  logic   [9:0]                  DATA_REQUIRED_CREDIT_IN,
...
assign BUFF_LOG_DATA = {P_NP_CPL, HEADER_DATA, TLP_START_BIT_IN, TLP_END_BIT_IN, TLP_TAG_IN, TLP_ID_IN/* , TLP_MEM_IO_MSG_CPL_COMP_IN */, DATA_REQUIRED_CREDIT_IN};

assign EMPTY = SEQUENCE_LOGGER_EMPTY;
RX_FIFO #(.DEPTH(DEPTH)/* .ADDR_WIDTH(7) */, .DATA_WIDTH(LOG_WIDTH)) SEQUENCE_LOGGER
(
...
.comb_DataOut({P_NP_CPL_OUT, HEADER_DATA_OUT, TLP_START_BIT_OUT_COMB, TLP_END_BIT_OUT_COMB, TLP_TAG_OUT, TLP_ID_OUT
/* , TLP_MEM_IO_MSG_CPL_COMP_OUT */,
DATA_REQUIRED_CREDIT_OUT}),//output logic [DATA_WIDTH-1:0] comb_DataOut,
//output logic        Full, 
