...
///////////FROM DL///////////////////////
    ...
    /* input  logic */            .new_tlp_ready(TLP_START_BIT_OUT_COMB), 
...
(
    ...
    .IN_TLP_DW(RX_IN_TLP_DW),                //input  logic [DATA_WIDTH-1:0]    IN_TLP_DW
    .WR_EN(RX_PNPC_BUFF_WR_EN),              //input  logic                     WrEn,
    .RD_EN(RX_RD_EN),                        //input  logic                     RdEn,
    .commit(RX_commit),
    .flush(RX_flush),
    .EMPTY(RX_ALL_BUFFS_EMPTY),
    .OUT_TLP_DW(RX_OUT_TLP_DW)               //output logic [DATA_WIDTH-1:0]    OUT_TLP_DW           
);
...
initial begin
    ...
    send_req_packet(.tlp_type_(0), .tlp_read_write_(1), .byte_count_(2), .address_(32'h00_00_00_06), .data1_(32'h0000_0001)
    ,.data2_(32'h0000_0001));
